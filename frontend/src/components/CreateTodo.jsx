...
const CreateTodo = () => {
    ...
    return (
        ...
        <div className="grid grid-cols-1 mx-[600px]  mt-10 items-center">
            ...
            <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-semibold rounded-lg px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 text-xl focus:outline-none dark:focus:ring-blue-800 mb-10 hover:scale-105 h-[50px] "
                onClick={() => {
